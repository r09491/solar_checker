...
setup(name='solar_checker',
      ...
      scripts=[
          ...
          './scripts/solar_checker_predict_minute_today.sh',
          './scripts/solar_checker_predict_minute_yesterday.sh',
          './scripts/solar_checker_find_minute_closest_default.sh',
          './scripts/solar_checker_find_minute_closest_today.sh',
          './scripts/solar_checker_find_minute_closest_yesterday.sh',
          './scripts/solar_checker_ef_ac_charge_set_once.py',
          './scripts/solar_checker_ef_ac_charge_set_once.sh',
          './scripts/solar_checker_home_load_set_fixed.py',
