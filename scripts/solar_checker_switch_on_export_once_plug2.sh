...
tail -n 19 $SOLAR_CHECKER_LATEST|solar_checker_switch_on_export_once.py \
     --plug_name plug2 \
     --power_mean_import_open 250 \
     --power_mean_export_closed 250 \
     --power_mean_deviation 100 \
     --power_samples 19 2>> $SOLAR_CHECKER_ERROR
